    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        <button
          ...
          focus:outline-none"
          v-on:click.prevent="newSong(song)"
          >
      ...
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          ...
          <div
            ...
            v-bind:class="comment_alert_variant"
          >
          ...
          >
            ...
            <button
              v-bind:disabled="comment_in_submission"
              type="submit"
...
<script>
import { songsCollections, commentsCollections, auth } from '@/includes/firebase';
...
export default {
  ...
  methods: {
    ...
    async getComments() {
      const snapshot = await commentsCollections
